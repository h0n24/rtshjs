/*
Real Time Syntax Highlighting JS - RTSHJS v0.73
	...
	keyHandler : function(evt) {
		evt = (evt) ? evt : (window.event) ? event : null;
	  	if(evt) {
			...
			// Syntax highlighting occurs for every time one of charcodes inside var chars is pressed
